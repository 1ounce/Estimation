...
export class Order{
    ...
    date:String="";
    advance:number=0;
    total:number=0;//sub total of the entire order
    ...
    generateOrderTotal()
    {
        ...
        this.total=this.itemSubTotal-this.oldGoldTotal;
...
export class OrderItem{
    ...
    {
        if(isStoneCharge)
         { console.log("generating individual stone charge");
   ...
   recalculateItemSubtotal(){
       this.generateMakingChargeSubTotal();
       this.generateStoneChargeSubTotal();
       var baseCost=this.weight*this.rate;
